...
* @version $Id: base_pagerating.php 39520 2014-03-05 16:43:31Z weinert $
*/
...
class base_pagerating extends base_db {
  ...
  */
   ...
   *
   * @param int $lngId optional, default value NULL
   * @param int $topicId
   * @access public
   * @return boolean
   */
  ...
  */
   ...
   * @return int 0 iff $a equals $b, -1 iff $a is less than $b, 1 otherwise.
   */
   ...
   * @param array $a the first array element of the comparison
   * @param array $b the second array element of the comparison
   * @return int 0 iff $a equals $b, -1 iff $a is greater than $b, 1 otherwise.
   */
